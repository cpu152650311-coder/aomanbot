...
const related = [
  ...
  { name: 'CRUZR', img: '/images/home/cruzr.webp', cat: 'Humanoid Service Robot', desc: 'AI-powered reception and customer guidance robot.', href: '/products/cruzr' },
]
...
const cleinbotM79JsonLd = pageJsonLd([
  organizationSchema(),
  productSchema({
    name: 'CLEINBOT M79',
    description: 'Autonomous industrial floor scrubbing robot with 2,000 m²/h efficiency, auto-return docking, multi-surface support, and cloud fleet management.',
    image: 'https://aomanbot.com/images/home/cleinbot-m79.webp',
    brand: 'AOMAN FUTURE',
    category: 'Cleaning Robot',
    url: 'https://aomanbot.com/products/cleinbot-m79',
  }),
  breadcrumbSchema([
    { name: 'Home', item: 'https://aomanbot.com' },
    { name: 'Products', item: 'https://aomanbot.com/products' },
    { name: 'CLEINBOT M79', item: 'https://aomanbot.com/products/cleinbot-m79' },
  ]),
  ...
  return (
    <main className="text-ink">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(cleinbotM79JsonLd) }}
      />
        ...
        <div className="container mx-auto px-6 py-24 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center hero-image-blend">
              <Image
                src="/images/products/cleinbot-m79/hero-robot.webp"
                alt="CLEINBOT M79"
                width={520}
                height={520}
                priority
      ...
      <section id="specs" className="py-24 bg-surface-subtle">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-14 items-start">
            {/* /images/products/cleinbot-m79/tech-drawing.webp */}
            <Image
              src="/images/products/cleinbot-m79/tech-drawing.webp"
